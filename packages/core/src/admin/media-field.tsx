  ...
  return (
    <div className="space-y-2">
      ...
      <p className="text-xs text-zinc-400">
        ...
        (p. ej. con HandBrake) o pega un enlace de YouTube, Vimeo, TikTok, Instagram o Facebook.
        Los enlaces de redes solo se ven si la publicación es <strong>pública</strong>.
      </p>
