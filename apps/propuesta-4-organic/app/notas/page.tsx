    ...
    <>
      ...
      <main className="mx-auto min-h-screen max-w-6xl px-5 pb-24 pt-32 sm:px-8">
        <header className="text-center">
          <p className="font-display text-sm font-bold uppercase tracking-wide text-terra">Archivo</p>
        ...
        <div className="text-center">
          <Link href="/" className="font-display font-bold text-terra hover:underline">
            ← Volver al inicio
          </Link>
        </div>
      </main>
