      ...
      <main className="pt-28">
        <article className="mx-auto max-w-3xl px-5 pb-24 sm:px-8">
          ...
          <header className="mt-6 border-b border-line pb-8">
            ...
            {post.resumen ? (
              <p className="mt-4 font-display text-xl italic text-ink-soft">{post.resumen}</p>
            ) : null}
          </header>

          {post.portada_url ? (
            <div className="relative my-10 aspect-[16/9] overflow-hidden border border-line bg-paper-2">
              <Image
