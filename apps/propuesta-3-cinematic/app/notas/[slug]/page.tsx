    ...
    <>
      ...
      <main className="pt-28">
        <article className="mx-auto max-w-3xl px-5 pb-24 sm:px-8">
          <Link
            href="/notas"
            className="text-sm font-medium uppercase tracking-widest text-accent-2 hover:underline"
          >
            ← Notas
          </Link>
          ...
          <header className="mt-6">
            ...
            {post.resumen ? (
              <p className="mt-4 text-xl text-muted">{post.resumen}</p>
            ) : null}
          </header>

          {post.portada_url ? (
            <div className="glass relative my-10 aspect-[16/9] overflow-hidden rounded-2xl">
              <Image
